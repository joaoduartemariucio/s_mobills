...
class _$UserUpdateRequestImpl extends _UserUpdateRequest {
  ...
  @override
  String toString() {
    return 'UserUpdateRequest(name: $name, age: $age, email: $email)';
  }
...
abstract class _UserUpdateRequest extends UserUpdateRequest {
  factory _UserUpdateRequest(
      {required final String name,
      required final int age,
      required final String email}) = _$UserUpdateRequestImpl;
  _UserUpdateRequest._() : super._();
